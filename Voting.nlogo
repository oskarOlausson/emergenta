globals[poll result parties nr-parties count-max one-vote] ;; polls is the result of previous election
...
to-report voting-chance [likeable poll-result]
  ...
  ifelse likeable < 1 or poll-result < .5 [
    set return exp(-((poll-result - .5) ^ 2) / 0.32)
  ]
  [
    set return 1
  ]
